                    ...
                    <div class="row">
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default light">
                                    <i class="fa fa-plus" onclick="javascript:window.location.href='/oa_web_war_exploded/employee/to_add';"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <c:forEach items="${list}" var="emp">
                            <tr class="message-unread">
                                ...
                                <td>
                                    <a href="to_update?sn=${emp.sn}">编辑</a>
                                    <a href="remove?sn=${emp.sn}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
