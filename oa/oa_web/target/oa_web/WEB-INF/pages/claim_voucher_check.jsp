        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <form:form id="admin-form" name="addForm" action="check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <c:if test="${sessionScope.employee.post==Content.POST_FM || sessionScope.employee.post==Content.POST_GM}">
                                    <button type="submit" class="button" name="dealWay" value="${Content.DEAL_PASS}" >${Content.DEAL_PASS}</button>
                                    <button type="submit" class="button" name="dealWay" value="${Content.DEAL_BACK}" >${Content.DEAL_BACK}</button>
                                    <button type="submit" class="button" name="dealWay" value="${Content.DEAL_REJECT}" >${Content.DEAL_REJECT}</button>
                                </c:if>
                                <c:if test="${sessionScope.employee.post==Content.POST_CASHIER}">
                                    <button type="submit" class="button" name="dealWay" value="${Content.DEAL_PAID}" >${Content.DEAL_PAID}</button>
                                </c:if>
